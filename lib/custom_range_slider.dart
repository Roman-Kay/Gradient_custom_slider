...
import 'colors_config/app_colors_config.dart';
...
class _CustomRangeSliderState extends State<CustomRangeSlider>
  ...
  Thumb? _defaultRangeThumbSelector(
    ...
    final double touchRadius =
        math.max(thumbSize.width, CustomRangeSlider._minTouchTargetWidth) / 2;
  ...
  Widget build(BuildContext context) {
    ...
    const RangeSliderTrackShape _defaultTrackShape =
        _RoundedRectRangeSliderTrackShape1();
...
class _RangeSliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  final ValueChanged<RangeValues>? onChangeEnd;
  final SemanticFormatterCallback? semanticFormatterCallback;
  final _CustomRangeSliderState state;
...
class _RenderRangeSlider extends RenderBox
  ...
  _RenderRangeSlider({
    ...
    required this.onChangeStart,
    required this.onChangeEnd,
    required _CustomRangeSliderState state,
  ...
  final _CustomRangeSliderState _state;
...
class _RenderValueIndicator extends RenderBox
  ...
  late Animation<double> _valueIndicatorAnimation;
  late _CustomRangeSliderState _state;
...
class _RoundedRectRangeSliderTrackShape1 extends RangeSliderTrackShape {
  ...
  const _RoundedRectRangeSliderTrackShape1();
